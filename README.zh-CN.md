...
[oo CLI](https://github.com/oomol-lab/oo-cli) 对 OSS runtime 的支持也正在从商业版迁移适配，目标是在
...
- 面向 Agent 的调用入口，支持 [Connector SDK](https://github.com/oomol-lab/connector-sdk)、
  MCP、HTTP API、OpenAPI 和本地 Web 控制台；[oo CLI](https://github.com/oomol-lab/oo-cli) 正在做 OSS
  适配。
...
| [oo CLI](https://github.com/oomol-lab/oo-cli)               | OSS runtime 支持正在从商业版迁移适配，目标是在 2026 年 7 月中旬可用。                    |
